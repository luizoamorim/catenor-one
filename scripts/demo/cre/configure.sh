...
#   configure.sh --relay-url=https://<railway-host>             (Railway API relay; stages pull results — docs/deployment/RAILWAY.md)
#   configure.sh --callback-url=https://<public-host>            (a tunnel forwarding to the local receiver 127.0.0.1:8787)
